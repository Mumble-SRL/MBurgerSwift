#
#  Be sure to run `pod spec lint MBurgerSwift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/Mumble-SRL/MBurgerSwift.git", :tag => "1.0.10" }
  ...
  spec.source_files  = "MBurgerSwift/*.{h,m,swift}", "MBurgerSwift/**/*.{h,m,swift}"
